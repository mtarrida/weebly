import * as THREE from "https://cdnjs.cloudflare.com/ajax/libs/three.js/85/three.min.js";
import { contains } from "./weebly_scripts_2";

"use strict";

let elem = contains('div', 'general_text')
